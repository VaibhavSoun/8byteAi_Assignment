...
![EC2 Instances](docs/screenshots/Screenshot%202026-09-09%20235607.png)

### App EC2 Security Groups (Least Privilege — Port 8000 from ALB only)
![App Security Groups](docs/screenshots/Screenshot%202026-09-09%20235717.png)

### App EC2 CloudWatch Monitoring
![App Monitoring](docs/screenshots/Screenshot%202026-09-09%20235809.png)

### Monitoring EC2 Security Groups (Port 3000 Grafana, 9090 Prometheus)
![Monitoring Security Groups](docs/screenshots/Screenshot%202026-09-09%20235851.png)

### Monitoring EC2 CloudWatch Monitoring
![Monitoring EC2](docs/screenshots/Screenshot%202026-09-09%20235914.png)

### RDS PostgreSQL — Available, Encrypted, Private
![RDS Security](docs/screenshots/Screenshot%202026-09-09%20235958.png)
![RDS Summary](docs/screenshots/Screenshot%202026-09-10%20000021.png)

### VPC Resource Map (4 Subnets, IGW, NAT, Route Tables)
![VPC](docs/screenshots/Screenshot%202026-09-10%20000107.png)

### Application Load Balancer — Active, Internet-facing
![ALB](docs/screenshots/Screenshot%202026-09-10%20000153.png)

### ALB Resource Map — Both Targets Healthy ✅
![ALB Resource Map](docs/screenshots/Screenshot%202026-09-10%20003014.png)

### ECR Repository (AES-256 Encrypted)
![ECR Repo](docs/screenshots/Screenshot%202026-09-10%20001646.png)

### ECR Image Pushed (64MB, tagged latest)
![ECR Image](docs/screenshots/Screenshot%202026-09-10%20010242.png)

### AWS Secrets Manager — 2 Secrets (DB + Grafana)
![Secrets Manager](docs/screenshots/Screenshot%202026-09-10%20001606.png)
...
![FastAPI Swagger](docs/screenshots/Screenshot%202026-09-10%20002428.png)

### Health Endpoint — `{"status":"healthy"}`
![Health Check](docs/screenshots/Screenshot%202026-09-10%20002452.png)

### Root Endpoint Response
![Root](docs/screenshots/Screenshot%202026-09-10%20002513.png)

### Docker Container Running on EC2 (via SSM Session Manager)
![Docker Running](docs/screenshots/Screenshot%202026-09-10%20002618.png)
...
![Build Pipeline](docs/screenshots/Screenshot%202026-09-10%20002911.png)

### Full Staging Pipeline — Succeeded ✅
![Staging Success](docs/screenshots/Screenshot%202026-09-10%20010308.png)

### Production Pipeline — Manual Approval + Security Gate
![Production Pipeline](docs/screenshots/Screenshot%202026-09-10%20011016.png)

### Production Trivy Security Gate — Blocking CRITICAL CVEs
![Trivy Security Gate](docs/screenshots/Screenshot%202026-09-10%20011041.png)
...
![Grafana EC2 Dashboard](docs/screenshots/Screenshot%202026-09-10%20000711.png)
...
![Grafana RDS Dashboard](docs/screenshots/Screenshot%202026-09-10%20001222.png)
...
![CloudWatch Alarms](docs/screenshots/Screenshot%202026-09-09%20001534.png)
